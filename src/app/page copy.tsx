...
//   // Fetch and set the initial user balance
//   useEffect(() => {
...
//   // Initialize the logical index for the slot
//   useEffect(() => {
//     const initialIndex = safeLoopZone + centerSlot;
//     setLogicalIndex(initialIndex);
//   }, []);

//   // Handle the countdown timer for the game round
//   useEffect(() => {
...
//         // Control betting availability based on time left
//         if (next <= betBlockTime) setCanBet(false);
//         else setCanBet(true);

//         // End the round if time reaches zero
//         if (next <= 0) {
...
//           <button
//             disabled={!canBet}
//             onClick={() => placeBet("green", betAmount, points, setPoints, setBetColor, setRedBet, setGreenBet, setBlackBet, userId)}
...
//             disabled={!canBet}
//             onClick={() => 
//               placeBet("black", betAmount, points, setPoints, setBetColor, setRedBet, setGreenBet, setBlackBet, userId)}
